/* Generate token for OCM
Code taken from https://github.com/RedHatInsights/insights-results-smart-proxy/tree/master/amsclient
tests
*/
...
func main() {
	...
	token := MakeTokenString("Bearer", 5*365*24*time.Hour)
	fmt.Println(token)
